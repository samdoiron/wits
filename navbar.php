	...
	<div class="container">
		...
		<div class="collapse navbar-collapse">
			<ul class="nav navbar-nav">
				...
				<li <?php if (isset($about)) echo 'class="active"'; ?>><a href="news.php">News</a></li>
				<li <?php if (isset($portfolio)) echo 'class="active"'; ?>><a href="minutes.php">Meeting Minutes</a></li>
				<li <?php if (isset($members)) echo 'class="active"'; ?>><a href="members.php">Event </a></li>
